...
<div class="FormContainer">
    <form method="post" action="Remove.php" class="form" enctype="multipart/form-data">
        ...
        <input type="submit" value="Remove" class="btn" style="height: 40px; margin-top: 9%">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $SQL="DELETE FROM product "."WHERE ".$_POST["sw"]."=:where";
